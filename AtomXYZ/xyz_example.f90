...
!! This module provides raw coordinate data for use with AtomXYZ
...
contains
    ...
    ! Requires: use AtomXYZ, only: atom, coord, createAtom
    function get_atoms_xyz_chignolin() result(atoms)
            use AtomXYZ, only: atom, coord, createAtom
            ...
            do i = 1, nAtoms
                    ...
                    atoms(i) = createAtom(position, elements(i))
            end do
